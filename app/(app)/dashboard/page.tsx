  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm mt-0.5" style={{ color: '#9090a8' }}>{months[month - 1]} {year}</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <StatCard label="Общий баланс" value={formatCurrency(totalBalance)} color="#6366f1" icon="◈" />
      ...
      <div className="rounded-2xl p-5" style={{ background: '#1a1a24', border: '1px solid #2a2a3a' }}>
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="/transactions" className="text-xs hover:underline" style={{ color: '#6366f1' }}>Все →</a>
        </div>
